    ...
    render() {
        return (
            <div className="container" id="profileContainer">
                <div className="row">
                    <div class="col-xs-12 col-sm-6 col-md-6" id="main-column">
                        <div className="well well-sm">
                            <div className="row">
                                <div className="col-sm-6 col-md-4">
                                    <img src="/images/profilePhoto.jpeg" alt="profileImage" className="img-rounded img-responsive" id="profileId"></img>
                                </div>
                                <div className="col-sm-6 col-md-8">
                                    <h4>Aibek Ramazanov</h4>
